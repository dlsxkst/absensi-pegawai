...
$sql = "SELECT * FROM attendances JOIN users ON attendances.employee_id = users.employee_id ORDER BY tgl, clock_in ASC";
$result = $db->query($sql);
$data = [];
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $jam_pulang = date("Y-m-d 17:00:00");
                            foreach ($data as $d) : ?>
                            <?php 
                            $pc = strtotime($d['clock_out']) - strtotime($jam_pulang); 
                            $tlt = strtotime($d['clock_in']) - strtotime($jam_masuk);
                            ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= $d['employee_id']; ?></td>
                                    ...
                                    <?php 
                                        if ($tlt > 0) {
                                            $telat = floor($tlt / 60); // hitung telat dalam menit
                                            echo "<td>".$telat. " menit". "</td>";
                                        } else {
                                            $telat = 0;
                                            echo "<td>".$telat. " menit". "</td>";
                                        }
                                    ...
                                    <?php 
                                        if ($pc < 0) {
                                            $pulang_cepat = floor(-$pc / 60); // hitung pulang cepat dalam menit
                                            echo "<td>".$pulang_cepat. " menit". "</td>";
                                        } else {
                                            $pulang_cepat = 0;
                                            echo "<td>".$pulang_cepat. " menit". "</td>";
                                        }
                                    ...
                                    <?php 
                                    if ($pc > 0) {
                                        $lembur = floor($pc / 60); // hitung lembur dalam menit
                                        echo "<td>".$lembur. " menit". "</td>";
                                    } else {
                                        $lembur = 0;
                                        echo "<td>".$lembur. " menit". "</td>";
                                    }
