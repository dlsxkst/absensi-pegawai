...
$select = "SELECT count(employee_id) AS jadmin FROM users WHERE role ='admin'";
$r = $db->query($select);
$res = $r->fetch_array();
$jadmin = $res['jadmin'];

$selectu = "SELECT count(employee_id) AS juser FROM users WHERE role ='pegawai'";
$ru = $db->query($selectu);
$resu = $ru->fetch_array();
$juser = $resu['juser'];
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <!-- <button type="submit" name='logout' class="nav-link px-3 btn btn-outline-danger">
                    <span>Keluar</span>
                </button> -->
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Pegawai</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $juser ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Admin</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jadmin ?></div>
                                        </div>
                                        <div class="col-auto">
